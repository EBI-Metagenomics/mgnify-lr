...
parser.add_argument('-i', '--minLenIll', type=int, help='Minimal length size for illumina reads, default: 20', default=20)
...
if par.mode == "assembly":
    if par.host: # assembly with Host filtering
        oh.write("host_index:\n  class: File\n  path: {}\n".format(par.host))
        oh.write("host_unmaped: {}\n".format(par.prefix + "filterHost.fastq.gz"))
